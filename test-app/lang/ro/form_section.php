...
return [
    ...
    'Move from :from to :to on :on for :for' => 'Mutați de la :from la :to pe :on pentru :for',
    ...
    'fields.amount.helper' => 'Taxa este un substantiv aici, nu acțiunea.',
    ...
    'fields.display_name.label' => 'Nume de afișare',
    ...
    'fields.email.helper' => 'Nu vom împărtăși niciodată această adresă.',
    ...
    'fields.full_name.helper' => 'Utilizați numele care ar trebui să apară pe factură.',
    ...
    'fields.full_name.placeholder' => 'de exemplu, Alex Rivera',
    ...
    'helper.description' => '"Salvează" salvează modificările, în timp ce "Salvează ca schiță" le păstrează private.',
    ...
    'helper.title' => 'Context verificare',
    ...
    'subtitle' => 'Etichetele scurte de mai jos se bazează pe context, nu pe semnificația literală.',
